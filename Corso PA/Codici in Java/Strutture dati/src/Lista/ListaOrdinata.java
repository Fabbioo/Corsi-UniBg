...
public class ListaOrdinata<E extends Comparable<? super E>> {
	...
	// Il metodo cancella() riceve come parametro un riferimento e ed elimina dalla
	// lista la prima occorrenza di un oggetto uguale a quello riferito da e, se
	// presente.
	...
	// Il metodo trova() restituisce l'intero indicante la posizione dell'elemento
	// nella lista.
