...
public class Stack<E> {
	...
	// Il metodo inserisci() aggiunge in cima allo stack l'oggetto e di tipo E
	...
	// Il metodo preleva() restituisce il riferimento all'oggetto che si trova in
	// cima allo stack, eliminandolo (sganciandolo) dallo stack.
	public E preleva() {
		if (cima == null)
